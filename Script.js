function withdraw_click(){
    ...
    const withdraws = "8438230211";
    const withdraw_passwords = "1@23456789";
    let total =20000;
...
function deposite_click(){
    ...
    const deposites = "8438230211";
    const deposite_passwords = "1@23456789";
    let total = 20000;
...
function balance_click(){
    ...
    const balances = "8438230211";
    const balance_passwords = "1@23456789";
    let total = 20000;
